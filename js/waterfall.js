$( window ).on( "load", function(){
    waterfall('main','pin');
    var dataInt={'data':[{'src':'r40.jpg'},{'src':'r48.jpg'},{'src':'r51.jpg'},{'src':'r47.jpg'}]};
...
function waterfall(parent,pin){
    var $aPin = $( "#main>div" );
    var iPinW = $aPin.eq( 0 ).outerWidth();// 一个块框pin的宽，outerwidth是将padding，margin都计算在内
